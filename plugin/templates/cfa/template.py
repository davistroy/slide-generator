...
LAYOUTS = {
    "title_slide": {
        ...
        "logo": {"x": 7.05, "y": 2.10, "w": 5.89, "h": 5.00},
    },
    "section_break": {
    ...
    "content_text_and_image": {
        "background_color": "#FFFFFF",
        "left_panel": {"x": 0.0, "y": 0.0, "w": 5.36, "h": 7.50, "fill": "#EEEDEB"},
        "title": {
            "x": 0.11,
            "y": 0.16,
            "w": 5.05,
...
class CFAPresentation(PresentationTemplate):
    ...
    def _add_image(self, slide, spec: dict, image_path: str):
        ...
        return slide.shapes.add_picture(
            image_path, Inches(x), Inches(y), Inches(final_w), Inches(final_h)
        )

    def _apply_bullet_formatting(
        self, paragraph, level: int, bullet_color: str = BULLET_COLOR
    ):
        """
