...
The following v1.0 packages have been archived to `../archive/old-distributions/`:
- `cfa-ppt-v1.0.zip` - Original CFA template (31 KB)
- `stratfield-ppt-v1.0.zip` - Original Stratfield template (614 KB)

**Note:** These packages are superseded by the templates in `presentation-skill-v1.1.0.zip`. Use the main package instead.
...
Full documentation is available in the parent repository:
- `docs/CHANGELOG.md` - Complete version history
- `docs/REGENERATE_SKILLS.md` - Package build instructions
- `README.md` - Main project documentation
- `CLAUDE.md` - Claude Code AI guidelines
